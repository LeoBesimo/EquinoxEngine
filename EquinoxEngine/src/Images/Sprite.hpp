...
namespace eq
{
	...
	public:
		...
		Sprite(unsigned int width, unsigned int height, BitmapTexture& texture);
		Sprite(unsigned int xOffset, unsigned int yOffset, unsigned int width, unsigned int height, BitmapTexture& texture);
